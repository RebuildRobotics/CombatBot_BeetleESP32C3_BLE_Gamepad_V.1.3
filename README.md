...
****************************************
  ...
  Free script for controlling 150-450 g Combat Robots with with gamepad via bluetoothLE.
  
  Script can also be used to control basic Arduino based bots with servo.
  ...
  *****
  ...
  - Can be controlled with max. 4 controllers at the same time (Not tested yet, library should work atleast).
  ...
  *****
  ...
  - Bluetooth pairing in Stadia gamepad is done by turning controller on and pressing google button + Y button 2 seconds until light turns orange and after that static white when connected to ESP.
    After pairing device once controller will automaticly reconnect to bot when both are turned on (With Stadia it seems to take a for ever or never).
  - Controls:
      ...
      - Left stick          =   Weapon
      - Right stick         =   Driving
  - Controller sends confirmations by vibrating:
